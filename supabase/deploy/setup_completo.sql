...
-- ────────────────────────────────────────────────────────────────────────────
-- >>> supabase/migrations/20260710000006_control.sql
-- ────────────────────────────────────────────────────────────────────────────
-- ============================================================================
-- DIPREM CRM — Migración 0006: Panel de Control del dueño
...
alter table proyectos_mercado
  add column asignado_por uuid references usuarios(id);
...
create view public.v_gestion_proyectos
with (security_invoker = true) as
select
  pm.id,
...
create view public.v_historial_asignaciones
with (security_invoker = true) as
select
  pm.id,
  pm.nombre      as proyecto,
...
-- ────────────────────────────────────────────────────────────────────────────
-- >>> supabase/migrations/20260710000007_asignacion_mejorada.sql
-- ────────────────────────────────────────────────────────────────────────────
-- ============================================================================
...
-- ────────────────────────────────────────────────────────────────────────────
-- >>> supabase/migrations/20260710000008_contactos_enriquecidos.sql
-- ────────────────────────────────────────────────────────────────────────────
-- ============================================================================
...
-- ────────────────────────────────────────────────────────────────────────────
-- >>> supabase/migrations/20260710000009_reportes.sql
-- ────────────────────────────────────────────────────────────────────────────
-- ============================================================================
-- DIPREM CRM — Migración 0009: Reportes para el dueño
...
-- ---------------------------------------------------------------------------
create view public.v_conversion_proyectos
with (security_invoker = true) as
select
  pm.id,
  pm.nombre  as proyecto,
...
-- ---------------------------------------------------------------------------
create function public.notificar_reporte_semanal()
returns int language plpgsql security definer set search_path = public as $$
declare
...
-- ────────────────────────────────────────────────────────────────────────────
-- >>> supabase/migrations/20260710000010_comunicacion.sql
-- ────────────────────────────────────────────────────────────────────────────
-- ============================================================================
