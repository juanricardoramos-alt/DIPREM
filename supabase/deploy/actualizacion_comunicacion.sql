-- ============================================================================
-- DIPREM CRM — ACTUALIZACIÓN: Comunicación interna (notas + campana)
...
-- ✅ Listo. Prueba: deja una nota en un lead de otro usuario y revisa
--   select titulo, mensaje from notificaciones order by creado_en desc limit 3;
