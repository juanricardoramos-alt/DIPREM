-- ============================================================================
-- DIPREM CRM — ACTUALIZACIÓN: Asignación mejorada (prioridad, fecha límite, nota)
-- Para proyectos que ya corrieron actualizacion_control.sql.
...
--   select public.alertar_proyectos_vencidos(); -- dispara las alertas a mano
