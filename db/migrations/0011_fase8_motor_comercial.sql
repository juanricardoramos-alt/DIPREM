-- ============================================================================
-- DIPREM CRM — Migración 0011 (Neon): Fase 8 — Motor comercial (solo esquema)
...
-- ---------------------------------------------------------------------------
create schema if not exists extensions;  -- en Neon no existe por defecto
...
-- Políticas RLS: en la migración de seguridad. Mismo perímetro que
-- proyectos_mercado (admin y gerente); sin política de delete a propósito:
-- los lotes de importación no se borran (trazabilidad).
...
-- Políticas RLS: en la migración de seguridad (lectura para autenticados
-- con perfil; escritura solo admin).
